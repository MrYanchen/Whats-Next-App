                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <div class="row">
                            ...
                            <form:form modelAttribute="register" method="POST" action="register" enctype="multipart/form-data" role="form">
                              <div class="form-group">
                                <form:label path="registerName">Name</form:label>
                                <form:input path="registerName" type='text' class="form-control" placeholder="Enter user name" />
                                <form:errors path="registerName" cssClass="error"></form:errors>
                              </div>
                              <div class="form-group">
                                <form:label path="registerPassword">Password</form:label>
                                <form:input path="registerPassword" class="form-control" placeholder="Enter password" />
                                <form:errors path="registerPassword" cssClass="error"></form:errors>
                              </div>
                              <div class="form-group">
                                <form:label path="registerPhone">Phone Number</form:label>
                                <form:input path="registerPhone" type='text' class="form-control" placeholder="Enter phone number" />
                                <form:errors path="registerPhone" cssClass="error"></form:errors>
                              </div>
                              <div class="form-group">                               
                                <form:label path="registerEmail">Email Address</form:label>
                                <form:input path="registerEmail" type='text' class="form-control" placeholder="Enter e-mail address" />
                                <form:errors path="registerEmail" cssClass="error"></form:errors>
                              </div>
